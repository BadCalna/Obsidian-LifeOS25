...
- # Creating a scope of work
	...
	- **工作说明书（SOW）主要是一种组织工具，旨在帮助分析师做出高效且影响深远的决策。它强调技术层面，即每次都遵循相同的步骤，以确保分析师的行动目标明确。能够清晰地描述您的流程和方法，体现了您做事认真细致、能够贯彻执行项目并能将有效框架应用于工作的能力。**
- # Staying objective
	- 数据在context中才具有准确意义
	- 数据具有主观性
	- 确保数据收集的准确很关键，需要考虑
...
- # The importance of Context
	- context其实就是上下文，和LLM的上下文很相似 —— 给定数据所处的环境和取数的条件
	- 如果数据没有上下文，那么数据的价值就体现不出来
	- **上下文可以将原始数据转化为有意义的信息**
	- 
---
